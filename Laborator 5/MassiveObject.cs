...
namespace Reut
{
    public class MassiveObject
    {
       ...
       static string startupPath = Path.Combine(Directory.GetParent(System.IO.Directory.GetCurrentDirectory()).Parent.FullName, "assets/Anvil.obj");
        
       
      

        String sFilePath = startupPath.Replace("\\", "/");
       
        //private const String FILENAME = "assets/soccer_ball.obj";
        // private const String sFilePath= "G:/lab egc/lab5/Reut/assets/Anvil.obj";
        ...
        private const float FACTOR_SCALARE_IMPORT = 15;
        ...
        public MassiveObject(Color col)
        {
            ...
            try
            {
                coordsList = LoadFromObjFile(sFilePath);
            ...
            {
                Console.WriteLine("ERROR: assets file <" + sFilePath + "> is missing!!!");
                hasError = true;
            }
        }
